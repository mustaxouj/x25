...
public class Banque {
    ...
    public Banque(String nom, String adresse, String tel, String mail) {
        ...
        emailBanque = mail;
        Client client1 = new Client("client1", "client", "ALAOUI", "Mohamed", "alaoui@gmail.com", "GA65066",
                "O666157849", Sexe.HOMME);
        Client client2 = new Client("client2", "client", "CHAKROUN", "Sara", "chakroun@gmail.com", "GA65118",
                "O666152498", Sexe.FEMME);
        Client client3 = new Client("client2", "client", "TALBBI", "Foad", "talbbi@gmail.com", "GA65223",
                "O666152132", Sexe.HOMME);
